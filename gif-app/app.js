$(document).ready(function() {
    ...
    //Starting point for loading favorite GIFs from local storage courtesy of Jack on StackOverflow: https://stackoverflow.com/a/12169405
$(function() {
    if (localStorage["myKey"] != null) {
       var contentsOfOldDiv = JSON.parse(localStorage["myKey"]);    
       $("#favoritesDiv").html(contentsOfOldDiv);
      } 
 });
        ...
        console.log("test");
            ...
            $.ajax({
              ...
              .then(function(response) {
                ...
                //Add class to the favorites button
                favoritesButton.attr("type", "button");
                ...
                gifDiv.prepend(favoritesButton);
                gifDiv.prepend(p);
                ...
                //Move favorite GIFs to their own div
                $(".favoritesButton").on("click", function() {
                
                    console.log("Favorites Button clicked");
                
                    $(".favoritesDiv").append($(this).parent());
                    $(this).hide();
                    //Starting point for storage favorite GIFs from local storage courtesy of Jack on StackOverflow: https://stackoverflow.com/a/12169405
                    $(function() {
                        localStorage["myKey"] = JSON.stringify($("#favoritesDiv").html());
                      });
